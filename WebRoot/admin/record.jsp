...
String sql="select * from media_adminrecord where adr_num='"+num.toString()+"' order by adr_id desc";
ResultSet rs=conn.stmt.executeQuery(sql);%>
 <table width="100%" border="1" bordercolor="#CCCCCC">
	...
	<%if(!id.equals("0")){
	 ...
	 rs.next();
	 out.print(name.toString()+"的记录: "+rs.getString(3));
	 }
	%><br>
	<a href="adminrecord.jsp">返回</a>
</body>
</html>