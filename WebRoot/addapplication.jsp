...
<form action=.Addapplicationruku?ok=0" method="get" name="form">
...
String floor2=rs2.getString(2);
  out.print("<td heigh='20'>");out.print("<a href='addaplication_.jsp?week="+week+"&area="+area+"&weekday="+weekday+"&jieci="+strjieci[jiecistart]+"&ok="+rs.getString(3)+"&alljie="+alljie+"&floor1="+floor1+"'>申请&nbsp;"+area+""+floor2+""+introom%1000+"</a><br>目前状态:");
